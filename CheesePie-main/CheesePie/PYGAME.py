...
def check_move(piece_type, piece_color ,trying_to_move_to_row, trying_to_move_to_col, pre_move_row, pre_move_col, piece_starting_pos):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if (selected_piece is not None or piece_type is not None or piece_color is not None):
                ...
                if check_move(selected_piece_type, selected_piece_color, row, col, selected_piece_pre_row, selected_piece_pre_col, selected_piece_starting_pos):
